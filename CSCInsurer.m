/*
	CSCInsurer.h
	The implementation of properties and methods for the CSCInsurer object.
...
@implementation CSCInsurer
	...
	+ (CSCInsurer*) createWithNode: (CXMLNode*) node
	{
		...
		return (CSCInsurer*)[[CSCInsurer alloc] initWithNode: node];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCInsurer class]]) {
