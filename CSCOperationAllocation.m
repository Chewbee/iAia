/*
	...
	The implementation of properties and methods for the CSCOperationAllocation object.
...
@implementation CSCOperationAllocation
	...
	+ (CSCOperationAllocation*) createWithNode: (CXMLNode*) node
	{
		...
		return (CSCOperationAllocation*)[[CSCOperationAllocation alloc] initWithNode: node];
	}
	...
	{
		return [self serialize: @"OperationAllocation"];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCOperationAllocation class]]) {
