/*
	CSCReference.h
	The implementation of properties and methods for the CSCReference object.
	Generated by SudzC.com
*/
#import "CSCReference.h"

@implementation CSCReference
	...
	+ (CSCReference*) createWithNode: (CXMLNode*) node
	{
		...
		return (CSCReference*)[[CSCReference alloc] initWithNode: node];
	}
	...
	{
		return [self serialize: @"Reference"];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCReference class]]) {
