/*
	CSCPackage.h
	The implementation of properties and methods for the CSCPackage object.
...
@implementation CSCPackage
	...
	+ (CSCPackage*) createWithNode: (CXMLNode*) node
	{
		...
		return (CSCPackage*)[[CSCPackage alloc] initWithNode: node];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCPackage class]]) {
