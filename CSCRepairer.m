/*
	CSCRepairer.h
	The implementation of properties and methods for the CSCRepairer object.
...
@implementation CSCRepairer
	...
	+ (CSCRepairer*) createWithNode: (CXMLNode*) node
	{
		if(node == nil) { return nil; }
		return (CSCRepairer*)[[CSCRepairer alloc] initWithNode: node];
	}
	...
	{
		return [self serialize: @"Repairer"];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCRepairer class]]) {
