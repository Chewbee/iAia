/*
	CSCGeneralConditions.h
	The implementation of properties and methods for the CSCGeneralConditions object.
...
@implementation CSCGeneralConditions
	...
	+ (CSCGeneralConditions*) createWithNode: (CXMLNode*) node
	{
		if(node == nil) { return nil; }
		return (CSCGeneralConditions*)[[CSCGeneralConditions alloc] initWithNode: node];
	}
	...
	{
		return [self serialize: @"GeneralConditions"];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCGeneralConditions class]]) {
