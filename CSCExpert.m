/*
	CSCExpert.h
	The implementation of properties and methods for the CSCExpert object.
...
@implementation CSCExpert
	...
	+ (CSCExpert*) createWithNode: (CXMLNode*) node
	{
		if(node == nil) { return nil; }
		return (CSCExpert*)[[CSCExpert alloc] initWithNode: node];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCExpert class]]) {
