/*
	CSCWebSiteAddress.h
	The interface definition of properties and methods for the CSCWebSiteAddress object.
...
@interface CSCWebSiteAddress : CSCObject
{
	NSString* _DisplayId;
	...
	+ (CSCWebSiteAddress*) createWithNode: (CXMLNode*) node;
