/*
	CSCHealthInvoice.h
	The implementation of properties and methods for the CSCHealthInvoice object.
...
@implementation CSCHealthInvoice
	...
	+ (CSCHealthInvoice*) createWithNode: (CXMLNode*) node
	{
		...
		return (CSCHealthInvoice*)[[CSCHealthInvoice alloc] initWithNode: node];
	}
	...
	- (id) initWithNode: (CXMLNode*) node {
		if(self = [super initWithNode: node])
		{
			...
			self.ItemList = [[CSCArrayOfInvoiceItem createWithNode: [Soap getNode: node withName: @"ItemList"]] object];
		}
		return self;
	}
	...
	{
		return [self serialize: @"HealthInvoice"];
	}
	...
	- (NSMutableString*) serializeElements
	{
		...
		if (self.ItemList != nil && self.ItemList.count > 0) {
			[s appendFormat: @"<ItemList>%@</ItemList>", [CSCArrayOfInvoiceItem serialize: self.ItemList]];
		} else {
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCHealthInvoice class]]) {
