/*
	...
	The implementation of properties and methods for the CSCPremiumAdjustment object.
...
@implementation CSCPremiumAdjustment
	...
	+ (CSCPremiumAdjustment*) createWithNode: (CXMLNode*) node
	{
		...
		return (CSCPremiumAdjustment*)[[CSCPremiumAdjustment alloc] initWithNode: node];
	}
	...
	- (id) initWithNode: (CXMLNode*) node {
		if(self = [super initWithNode: node])
		{
			...
			self.Identifier = [[Soap getNodeValue: node withName: @"Identifier"] intValue];
	...
	{
		return [self serialize: @"PremiumAdjustment"];
	}
	...
	- (NSMutableString*) serializeElements
	{
		...
		[s appendFormat: @"<Identifier>%@</Identifier>", [NSString stringWithFormat: @"%i", self.Identifier]];
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCPremiumAdjustment class]]) {
