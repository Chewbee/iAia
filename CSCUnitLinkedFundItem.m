/*
	...
	The implementation of properties and methods for the CSCUnitLinkedFundItem object.
...
@implementation CSCUnitLinkedFundItem
	...
	+ (CSCUnitLinkedFundItem*) createWithNode: (CXMLNode*) node
	{
		...
		return (CSCUnitLinkedFundItem*)[[CSCUnitLinkedFundItem alloc] initWithNode: node];
	}
	...
	{
		return [self serialize: @"UnitLinkedFundItem"];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCUnitLinkedFundItem class]]) {
