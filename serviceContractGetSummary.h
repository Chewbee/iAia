...
@interface serviceContractGetSummary : SoapService
	...
	- (SoapRequest*) ContractGetSummary: (id) target action: (SEL) action Environment: (CSCWMEnv*) Environment ActivityRequest: (CSCActivityRequest*) ActivityRequest Contract: (CSCContract*) Contract;
