/*
	CSCSwitch.h
	The implementation of properties and methods for the CSCSwitch object.
...
@implementation CSCSwitch
	...
	+ (CSCSwitch*) createWithNode: (CXMLNode*) node
	{
		...
		return (CSCSwitch*)[[CSCSwitch alloc] initWithNode: node];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCSwitch class]]) {
