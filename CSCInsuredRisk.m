/*
	CSCInsuredRisk.h
	The implementation of properties and methods for the CSCInsuredRisk object.
...
@implementation CSCInsuredRisk
	...
	+ (CSCInsuredRisk*) createWithNode: (CXMLNode*) node
	{
		if(node == nil) { return nil; }
		return (CSCInsuredRisk*)[[CSCInsuredRisk alloc] initWithNode: node];
	}
	...
	{
		return [self serialize: @"InsuredRisk"];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCInsuredRisk class]]) {
