...
@interface CSCContractDisplayExtractService : SoapService
	...
	- (SoapRequest*) ContractDisplayExtract: (id) target action: (SEL) action Environment: (CSCWMEnv*) Environment Contract: (CSCContract*) Contract;
