...
@interface ServiceContractCreate : SoapService
	...
	- (SoapRequest*) ContractCreate: (id) target action: (SEL) action Environment: (CSCWMEnv*) Environment ActivityRequest: (CSCActivityRequest*) ActivityRequest SavingsScheme: (CSCSavingsScheme*) SavingsScheme Contract: (CSCContract*) Contract;
