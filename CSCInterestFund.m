/*
	CSCInterestFund.h
	The implementation of properties and methods for the CSCInterestFund object.
...
@implementation CSCInterestFund
	@synthesize Extension = _Extension;
	@synthesize ExtensionList = _ExtensionList;
	@synthesize Code = _Code;
	@synthesize CurrentRate = _CurrentRate;
	@synthesize DistributionRate = _DistributionRate;
	@synthesize EstimatedCashValue = _EstimatedCashValue;
	...
	@synthesize GuaranteedCashValue = _GuaranteedCashValue;
	@synthesize GuaranteedRate = _GuaranteedRate;
	...
	+ (CSCInterestFund*) createWithNode: (CXMLNode*) node
	{
		...
		return (CSCInterestFund*)[[CSCInterestFund alloc] initWithNode: node];
	}
	...
	- (id) initWithNode: (CXMLNode*) node {
		if(self = [super initWithNode: node])
		{
			...
			self.CurrentRate = [NSDecimalNumber decimalNumberWithString: [Soap getNodeValue: node withName: @"CurrentRate"]];
			self.DistributionRate = [NSDecimalNumber decimalNumberWithString: [Soap getNodeValue: node withName: @"DistributionRate"]];
			self.EstimatedCashValue = [NSDecimalNumber decimalNumberWithString: [Soap getNodeValue: node withName: @"EstimatedCashValue"]];
			...
			self.GuaranteedCashValue = [NSDecimalNumber decimalNumberWithString: [Soap getNodeValue: node withName: @"GuaranteedCashValue"]];
			self.GuaranteedRate = [NSDecimalNumber decimalNumberWithString: [Soap getNodeValue: node withName: @"GuaranteedRate"]];
			self.ItemList = [[CSCArrayOfInterestFundItem createWithNode: [Soap getNode: node withName: @"ItemList"]] object];
	...
	{
		return [self serialize: @"InterestFund"];
	}
	...
	- (NSMutableString*) serializeElements
	{
		...
		if (self.CurrentRate != nil) [s appendFormat: @"<CurrentRate>%@</CurrentRate>", [NSString stringWithFormat: @"%@", self.CurrentRate]];
		...
		if (self.EstimatedCashValue != nil) [s appendFormat: @"<EstimatedCashValue>%@</EstimatedCashValue>", [NSString stringWithFormat: @"%@", self.EstimatedCashValue]];
		...
		if (self.GuaranteedCashValue != nil) [s appendFormat: @"<GuaranteedCashValue>%@</GuaranteedCashValue>", [NSString stringWithFormat: @"%@", self.GuaranteedCashValue]];
		if (self.GuaranteedRate != nil) [s appendFormat: @"<GuaranteedRate>%@</GuaranteedRate>", [NSString stringWithFormat: @"%@", self.GuaranteedRate]];
		if (self.ItemList != nil && self.ItemList.count > 0) {
			[s appendFormat: @"<ItemList>%@</ItemList>", [CSCArrayOfInterestFundItem serialize: self.ItemList]];
		} else {
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCInterestFund class]]) {
