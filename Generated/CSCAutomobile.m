/*
	CSCAutomobile.h
	The implementation of properties and methods for the CSCAutomobile object.
...
@implementation CSCAutomobile
	...
	+ (CSCAutomobile*) createWithNode: (CXMLNode*) node
	{
		...
		return (CSCAutomobile*)[[CSCAutomobile alloc] initWithNode: node];
	}
	...
	{
		return [self serialize: @"Automobile"];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCAutomobile class]]) {
