...
#import "CSCWorkManagementClient.h"
...
@implementation CSCWorkManagementClient
	...
	+ (CSCWorkManagementClient*) service {
		return [CSCWorkManagementClient serviceWithUsername:nil andPassword:nil];
	}
	
	+ (CSCWorkManagementClient*) serviceWithUsername: (NSString*) username andPassword: (NSString*) password {
		return [[CSCWorkManagementClient alloc] initWithUsername:username andPassword:password];
	}
