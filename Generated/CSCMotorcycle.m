/*
	CSCMotorcycle.h
	The implementation of properties and methods for the CSCMotorcycle object.
...
@implementation CSCMotorcycle
	...
	+ (CSCMotorcycle*) createWithNode: (CXMLNode*) node
	{
		if(node == nil) { return nil; }
		return (CSCMotorcycle*)[[CSCMotorcycle alloc] initWithNode: node];
	}
	...
	{
		return [self serialize: @"Motorcycle"];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCMotorcycle class]]) {
