/*
	CSCTruckCamper.h
	The implementation of properties and methods for the CSCTruckCamper object.
...
@implementation CSCTruckCamper
	...
	+ (CSCTruckCamper*) createWithNode: (CXMLNode*) node
	{
		if(node == nil) { return nil; }
		return (CSCTruckCamper*)[[CSCTruckCamper alloc] initWithNode: node];
	}
	...
	{
		return [self serialize: @"TruckCamper"];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCTruckCamper class]]) {
