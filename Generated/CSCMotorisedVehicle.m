/*
	...
	The implementation of properties and methods for the CSCMotorisedVehicle object.
...
@implementation CSCMotorisedVehicle
	...
	+ (CSCMotorisedVehicle*) createWithNode: (CXMLNode*) node
	{
		...
		return (CSCMotorisedVehicle*)[[CSCMotorisedVehicle alloc] initWithNode: node];
	}
	...
	- (id) initWithNode: (CXMLNode*) node {
		if(self = [super initWithNode: node])
		{
			...
			self.MaximumSpeed = [[Soap getNodeValue: node withName: @"MaximumSpeed"] intValue];
	...
	{
		return [self serialize: @"MotorisedVehicle"];
	}
	...
	- (NSMutableString*) serializeElements
	{
		...
		[s appendFormat: @"<MaximumSpeed>%@</MaximumSpeed>", [NSString stringWithFormat: @"%i", self.MaximumSpeed]];
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCMotorisedVehicle class]]) {
