/*
	CSCCaravan.h
	The implementation of properties and methods for the CSCCaravan object.
...
@implementation CSCCaravan
	...
	+ (CSCCaravan*) createWithNode: (CXMLNode*) node
	{
		if(node == nil) { return nil; }
		return (CSCCaravan*)[[CSCCaravan alloc] initWithNode: node];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCCaravan class]]) {
