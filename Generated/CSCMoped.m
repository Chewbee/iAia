/*
	CSCMoped.h
	The implementation of properties and methods for the CSCMoped object.
...
@implementation CSCMoped
	...
	+ (CSCMoped*) createWithNode: (CXMLNode*) node
	{
		if(node == nil) { return nil; }
		return (CSCMoped*)[[CSCMoped alloc] initWithNode: node];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCMoped class]]) {
