/*
	CSCBus.h
	The implementation of properties and methods for the CSCBus object.
...
@implementation CSCBus
	...
	+ (CSCBus*) createWithNode: (CXMLNode*) node
	{
		if(node == nil) { return nil; }
		return (CSCBus*)[[CSCBus alloc] initWithNode: node];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCBus class]]) {
