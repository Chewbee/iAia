...
@interface CSCWorkManagementClient : SoapService
	...
	- (SoapRequest*) ProductExtract: (id) target action: (SEL) action Environment: (CSCWMEnv*) Environment ActivityRequest: (CSCActivityRequest*) ActivityRequest Contract: (CSCContract*) Contract;
