/*
	CSCInsuredGroup.h
	The implementation of properties and methods for the CSCInsuredGroup object.
...
@implementation CSCInsuredGroup
	...
	+ (CSCInsuredGroup*) createWithNode: (CXMLNode*) node
	{
		if(node == nil) { return nil; }
		return (CSCInsuredGroup*)[[CSCInsuredGroup alloc] initWithNode: node];
	}
	...
	{
		return [self serialize: @"InsuredGroup"];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCInsuredGroup class]]) {
