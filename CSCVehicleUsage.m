/*
	CSCVehicleUsage.h
	The implementation of properties and methods for the CSCVehicleUsage object.
...
@implementation CSCVehicleUsage
	...
	+ (CSCVehicleUsage*) createWithNode: (CXMLNode*) node
	{
		...
		return (CSCVehicleUsage*)[[CSCVehicleUsage alloc] initWithNode: node];
	}
	...
	{
		return [self serialize: @"VehicleUsage"];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCVehicleUsage class]]) {
