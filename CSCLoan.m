/*
	CSCLoan.h
	The implementation of properties and methods for the CSCLoan object.
...
@implementation CSCLoan
	...
	+ (CSCLoan*) createWithNode: (CXMLNode*) node
	{
		...
		return (CSCLoan*)[[CSCLoan alloc] initWithNode: node];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCLoan class]]) {
