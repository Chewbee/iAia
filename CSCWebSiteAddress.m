/*
	CSCWebSiteAddress.h
	The implementation of properties and methods for the CSCWebSiteAddress object.
...
#import "CSCPerson.h"
@implementation CSCWebSiteAddress
	...
	+ (CSCWebSiteAddress*) createWithNode: (CXMLNode*) node
	{
		...
		return (CSCWebSiteAddress*)[[CSCWebSiteAddress alloc] initWithNode: node];
	}
	...
	{
		return [self serialize: @"WebSiteAddress"];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCWebSiteAddress class]]) {
