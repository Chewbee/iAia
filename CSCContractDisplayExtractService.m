...
@implementation CSCContractDisplayExtractService
	...
	+ (CSCContractDisplayExtractService*) service {
		return [CSCContractDisplayExtractService serviceWithUsername:nil andPassword:nil];
	}
	
	+ (CSCContractDisplayExtractService*) serviceWithUsername: (NSString*) username andPassword: (NSString*) password {
		return [[CSCContractDisplayExtractService alloc] initWithUsername:username andPassword:password];
	}
