...
@implementation serviceContractGetSummary
	...
	+ (serviceContractGetSummary*) service {
		return [serviceContractGetSummary serviceWithUsername:nil andPassword:nil];
	}
	
	+ (serviceContractGetSummary*) serviceWithUsername: (NSString*) username andPassword: (NSString*) password {
		return [[serviceContractGetSummary alloc] initWithUsername:username andPassword:password];
	}

		
	/* Returns CSCContract*.  */
	- (SoapRequest*) ContractGetSummary: (id <SoapDelegate>) handler Environment: (CSCWMEnv*) Environment ActivityRequest: (CSCActivityRequest*) ActivityRequest Contract: (CSCContract*) Contract
	{
		return [self ContractGetSummary: handler action: nil Environment: Environment ActivityRequest: ActivityRequest Contract: Contract];
	}

	- (SoapRequest*) ContractGetSummary: (id) _target action: (SEL) _action Environment: (CSCWMEnv*) Environment ActivityRequest: (CSCActivityRequest*) ActivityRequest Contract: (CSCContract*) Contract
		{
		...
		NSString* _envelope = [Soap createEnvelope: @"ContractGetSummary" forNamespace: self.namespace withParameters: _params withHeaders: self.headers];
		SoapRequest* _request = [SoapRequest create: _target action: _action service: self soapAction: @"ContractGetSummary" postData: _envelope deserializeTo: [CSCContract alloc]];
		[_request send];
		return _request;
	}
