/*
	CSCHealthFormula.h
	The implementation of properties and methods for the CSCHealthFormula object.
...
@implementation CSCHealthFormula
	...
	+ (CSCHealthFormula*) createWithNode: (CXMLNode*) node
	{
		...
		return (CSCHealthFormula*)[[CSCHealthFormula alloc] initWithNode: node];
	}
	...
	- (id) initWithNode: (CXMLNode*) node {
		if(self = [super initWithNode: node])
		{
			...
			self.ItemList = [[CSCArrayOfHealthFormulaItem createWithNode: [Soap getNode: node withName: @"ItemList"]] object];
	...
	{
		return [self serialize: @"HealthFormula"];
	}
	...
	- (NSMutableString*) serializeElements
	{
		...
		if (self.ItemList != nil && self.ItemList.count > 0) {
			[s appendFormat: @"<ItemList>%@</ItemList>", [CSCArrayOfHealthFormulaItem serialize: self.ItemList]];
		} else {
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCHealthFormula class]]) {
