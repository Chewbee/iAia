/*
	CSCAfterEffect.h
	The implementation of properties and methods for the CSCAfterEffect object.
...
@implementation CSCAfterEffect
	...
	+ (CSCAfterEffect*) createWithNode: (CXMLNode*) node
	{
		...
		return (CSCAfterEffect*)[[CSCAfterEffect alloc] initWithNode: node];
	}
	...
	{
		return [self serialize: @"AfterEffect"];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[CSCAfterEffect class]]) {
